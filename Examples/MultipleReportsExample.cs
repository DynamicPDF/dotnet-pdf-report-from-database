...
{
    internal class MultipleReportsExample
    {
        ...
        internal static void Run(string outputFilePath)
        {
            ...
            DocumentLayout documentLayout = new DocumentLayout(Util.GetResourcePath("MultipleReports.dlex"));
        ...
        private static void DocumentLayout_ReportDataRequired(object sender, ceTe.DynamicPDF.LayoutEngine.Data.ReportDataRequiredEventArgs args)
        {
            ...
            else if (args.ElementId == "ProductsByCategoryReport")
            {
                string sqlString =
